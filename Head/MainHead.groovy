...
class HeadOnNeck implements ICadGenerator, IParameterChanged{
	...
	LengthParameter headDiameter 		= new LengthParameter("Head Diameter", 130, [200,140])
	LengthParameter snoutLen 		= new LengthParameter("Snout Length", 120, [headDiameter.getMM()*2, headDiameter.getMM()/2])
	LengthParameter jawHeight 		= new LengthParameter("Jaw Height", 10, [200,10])
	...
	LengthParameter upperHeadDiam 	= new LengthParameter("Upper Head Height", 25, [300,0])
	LengthParameter leyeDiam 		= new LengthParameter("Left Eye Diameter", 40, [headDiameter.getMM()/2,56])
	LengthParameter reyeDiam 		= new LengthParameter("Right Eye Diameter", 40, [headDiameter.getMM()/2,56])
	...
	def headParts  = (ArrayList<CSG> )ScriptingEngine.gitScriptRun(
		"https://github.com/CounterfeitLlama/ParametricAnimatronics.git", 
