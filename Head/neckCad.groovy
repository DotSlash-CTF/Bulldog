//Your code hereimport com.neuronrobotics.bowlerstudio.creature.ICadGenerator;
...
class HeadOnNeck implements ICadGenerator, IParameterChanged{
	...
	public ArrayList<CSG> generateCad(DHParameterKinematics d, int linkIndex) {
		...
		if(linkIndex ==dhLinks.size()-1){
			...
			if(headParts==null)
			{
				def headmaker = ScriptingEngine.gitScriptRun("https://github.com/DotSlash-CTF/Bulldog.git", "Head/HeadGeneration.groovy" ,  null )
				headParts = headmaker.makeHead(false);
			}
